...
class PcscFieldPractice590 extends PcscFieldPracticeBase {
  ...
  public function buildPracticeForm(): array {
    ...
    $form['590_rate_unit'] = [
      ...
      '#options' => $this->getListOptions('590_rate_unit'),
      '#required' => TRUE,
    ];
    $form['590_rate_change'] = [
      '#type' => 'select',
      '#title' => $this->t('Nutrient application rate change'),
      '#options' => $this->getListOptions('590_rate_change'),
      '#required' => TRUE,
    ];
    return $form;
  }
